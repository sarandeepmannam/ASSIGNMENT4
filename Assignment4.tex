...
\end{proof}
Since $X_{1},X_{2},X_{3},...$ are mutually independent random variables ,by using lemma \brak{2.1} ,the random variables $X_{1}^{2},X_{2}^{2},X_{3}^{2},....$  are also mutually independent.
\begin{align}
